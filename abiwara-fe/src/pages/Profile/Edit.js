			...
			<section className="flex justify-center bg-white py-16 md:pt-20 px-4 md:px-0 dark:bg-[#161B26]">
				<div className="w-full max-w-6xl relative">
					<form id="profile-image__form" className="mt-10" onChange={handleSubmitImg}>
						<div id="navbar__profile" className="absolute -top-28 w-full flex items-center gap-4 md:gap-10">
					...
					<section className="dark:text-white md:w-1/2 mt-20">
					...
					{isLoadingImg ? (
						...
						<>
						{isLoading ?
							<button disabled type="button" className="mt-10 text-xs roboto rounded-lg border border-gray-500 px-4 py-2 hover:cursor-pointer hover:bg-black hover:text-white transition-all ease-in dark:text-white dark:hover:bg-gray-100 dark:hover:text-black bg-gray-300">
