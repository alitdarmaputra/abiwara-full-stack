...
export default function BookEdit() {
    ...
    const handlesubmitEditbook = async e => {
        ...
        if (title_input.value === "" || inventory_input.value === "" || quantity_input.value === "" || category.id === "") {
        ...
        try {
            ...
            await axiosInstance.put(`${httpRequest.api.baseUrl}/book/${id}`, payload);
            ...
            <div className="book__container bg-white rounded-lg p-5 mb-10 dark:bg-[#2D3748] dark:text-gray-200">
                <form>
                    ...
                    <div className="inventory_form mb-3">
                        ...
                        <input defaultValue={book.inventory_number} id="inventory_input" placeholder="Ketik no inventaris" className="font-sans focus:outline-black border-2 mt-2 w-full h-10 rounded-md p-2 dark:bg-transparent dark:border-gray-500" type="text"></input>
                    </div>

                    <div className="price_form mb-3">
                        <label className="font-bold text-sm" htmlFor="price_input">Harga</label>
                        <input defaultValue={book.price && numToIDR(book.price.toString())} onChange={formatValue} id="price_input" placeholder="ketik harga" className="font-sans focus:outline-black border-2 mt-2 w-full h-10 rounded-md p-2 dark:bg-transparent dark:border-gray-500" type="text"></input>
                    </div>
                    ...
                    <div className="year_form mb-3">
                        <label className="font-bold text-sm" htmlFor="published_input">Tahun Terbit</label>
                        <input defaultValue={book.year} id="year_input" placeholder="ketik tahun terbit" className="font-sans focus:outline-black border-2 mt-2 w-full h-10 rounded-md p-2 dark:bg-transparent dark:border-gray-500" type="text"></input>
                    </div>

                    <div className="city_form mb-3">
                        <label className="font-bold text-sm" htmlFor="city_input">Kota Terbit</label>
                        <input defaultValue={book.city} id="city_input" placeholder="Ketik kota terbit" className="font-sans focus:outline-black border-2 mt-2 w-full h-10 rounded-md p-2 dark:bg-transparent dark:border-gray-500" type="text"></input>
                    </div>

                    <div className="page_form mb-3">
                        <label className="font-bold text-sm" htmlFor="page_input">Jumlah Halaman</label>
                        <input defaultValue={book.total_page} id="page_input" placeholder="ketik jumlah halaman" className="font-sans focus:outline-black border-2 mt-2 w-full h-10 rounded-md p-2 dark:bg-transparent dark:border-gray-500" type="text"></input>
                    </div>
                    ...
                    <div className="status_form mb-3">
						...
						<select ref={status} className='block w-full h-10 font-sans bg-white rounded-md p-2 dark:bg-[#2D3748] mt-2 border-2 dark:border-gray-500' id="class_input" name="class">
							<option selected={status.current?.value === "BAIK" && "selected"} value="BAIK">Baik</option>
							<option selected={status.current?.value === "TIDAK BAIK" && "selected"} value="TIDAK BAIK">Tidak baik</option>
						</select>
                    </div>

                    <div className="entry_date_form mb-3">
                        <label className="font-bold text-sm" htmlFor="entry_date_input">Tanggal Masuk <span className="text-red-500">*</span></label>
                        <input defaultValue={book.entry_date && new Date(book.entry_date).toISOString().slice(0, 10)} id="entry_date_input" placeholder="tanggal pembelian" className="font-sans focus:outline-black border-2 mt-2 w-full h-10 rounded-md p-2 dark:bg-transparent dark:border-gray-500" type="date"></input>
                    </div>

                    <div className="source_form mb-3">
                        <label className="font-bold text-sm" htmlFor="source_input">Asal</label>
                        <input defaultValue={book.source} id="source_input" placeholder="Ketik asal dana" className="font-sans focus:outline-black border-2 mt-2 w-full h-10 rounded-md p-2 dark:bg-transparent dark:border-gray-500" type="text"></input>
                    </div>
                    ...
                    <div className="call_author_form mb-3">
                        ...
                        <input defaultValue={book.call_number_author}id="call_author_input" placeholder="Ketik nomor panggil pengarang" className="font-sans focus:outline-black border-2 mt-2 w-full h-10 rounded-md p-2 dark:bg-transparent dark:border-gray-500" type="text"></input>
                    </div>

                    <div className="call_title_form mb-3">
                        <label className="font-bold text-sm" htmlFor="call_title_input">Nomor Panggil Judul Buku</label>
                        <input defaultValue={book.call_number_title} id="call_title_input" placeholder="Ketik nomor panggil judul buku" className="font-sans focus:outline-black border-2 mt-2 w-full h-10 rounded-md p-2 dark:bg-transparent dark:border-gray-500" type="text"></input>
                    </div>
				...
				{isLoadingImg ? (
					<button disabled className="mt-10 w-full h-10 bg-gray-500 text-white font-bold rounded-lg" onClick={handlesubmitEditbook}>Edit</button>
				) : (
					<>
					{submitLoading ?
