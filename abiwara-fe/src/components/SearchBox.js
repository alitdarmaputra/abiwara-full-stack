...
export default function SearchBox() {
    return (
        <div id="search-box" className="flex flex-col items-center text-center">
            <form className="mx-2 flex items-center pl-4 pr-2 md:px-4 py-2 md:py-3 mt-36 translate-y-8 bg-white rounded-full md:rounded-md shadow-md dark:bg-[#2D3748] transition-all dark:text-gray-200">
                <AiOutlineSearch className="hidden lg:inline w-10 h-10 text-gray-400" />
                <input type="search" className="flex-grow w-[20rem] md:w-[33rem] text-sm md:text-xl px-4 focus:outline-none bg-transparent" placeHolder="Ketik judul, nama pengarang, atau penerbit" />
