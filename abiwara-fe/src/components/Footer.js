            ...
            <div id="footer__wrapper" className="max-w-6xl mb-10 text-sm w-full flex flex-col lg:flex-row justify-between">
                <div id="footer__about" className="mb-10 md:mb-0 md:max-w-64">
                    ...
                    <div className="flex gap-2 text-black dark:text-gray-400">
                        <a href="https://www.youtube.com/@smp3kediri794" className="hover:cursor-pointer"><AiFillYoutube className="h-8 w-8" /></a>
                ...
                <div id="footer__location" className="mb-10 md:mb-0 md:max-w-64">
					...
					<iframe
					  ...
					  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d4691.31578968449!2d115.1044839761631!3d-8.604657173060371!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dd239eb0b88096d%3A0x379b3404aa8592db!2sSMPN%203%20Kediri!5e0!3m2!1sid!2sid!4v1706974809492!5m2!1sid!2sid"
					  width="230"
					  height="230"
					  style={{ border: "0" }}					  
					  allowFullScreen=""
